...
select calisan_sayisi,marka_isim,(select sum(maas)from calisanlar where marka_isim=isyeri)
...
select marka_isim, calisan_sayisi,(select round(avg(maas),3)from calisanlar where marka_isim=isyeri)
